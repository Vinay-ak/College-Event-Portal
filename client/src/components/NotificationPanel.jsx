...
const data = [
  {
    ...
    text: "New event has been assigned to you and 2 others. The event priority is set a normal priority, so check and act accordingly. The task date is Thu Feb 29 2024. Thank you!!!",
    task: null,
    notiType: "alert",
    isRead: [],
  ...
  },
  {
    ...
    text: "New event has been assigned to you and 2 others. The event priority is set a high priority, so check and act accordingly. The task date is Fri Feb 09 2024. Thank you!!!",
    task: {
