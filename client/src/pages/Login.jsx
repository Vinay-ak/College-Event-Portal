        ...
        <div className="h-full w-full lg:w-2/3 flex flex-col items-center justify-center">
          <div className="w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:-mt-20">
            <span className="flex gap-1 py-1 px-3 border rounded-full text-sm md:text-base bordergray-300 text-gray-600">
              Manage all College Events in one place!
            </span>
            <p className="flex flex-col gap-0 md:gap-4 text-4xl md:text-6xl 2xl:text-7xl font-black text-center text-orange-600">
        ...
        <div className="w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center">
          ...
          >
            ...
            {isLoading? <Loading/> :<Button
              type="submit"
              label="Submit"
              className="w-full h-10 bg-orange-600 text-white rounded-full"
            />}
            </div>
          </form>
        </div>
